...
import { AdminFinanceView } from '@/components/dashboard/AdminFinanceView';
...
export default function FinancePage() {
    ...
    if (isLoading) {
        return (
            <div className="h-screen w-full flex flex-col items-center justify-center bg-white gap-4">
                ...
                <p className="text-[#0F2D1E] font-bold animate-pulse">Chargement des registres financiers...</p>
            </div>
        );
    }
    ...
    return (
        <DashboardLayout user={data.user}>
            <AdminFinanceView user={data.user} />
        </DashboardLayout>
    );
}

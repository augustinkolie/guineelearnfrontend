...
import { AdminRealtimeView } from '@/components/dashboard/AdminRealtimeView';
...
export default function AdminRealtimePage() {
    ...
    if (isLoading) {
        return (
            <div className="h-screen w-full flex flex-col items-center justify-center bg-white gap-4">
                ...
                <p className="text-[#0F2D1E] font-bold animate-pulse">Initialisation du Direct...</p>
            </div>
        );
    }
    ...
    return (
        <DashboardLayout user={data.user}>
            <AdminRealtimeView user={data.user} />
        </DashboardLayout>
    );
}

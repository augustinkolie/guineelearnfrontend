...
import { AdminLibraryView } from '@/components/dashboard/AdminLibraryView';
...
export default function AdminLibraryPage() {
    ...
    if (isLoading) {
        return (
            <div className="h-screen w-full flex flex-col items-center justify-center bg-white gap-4">
                ...
                <p className="text-[#0F2D1E] font-bold animate-pulse">Chargement de la bibliothèque...</p>
            </div>
        );
    }
    ...
    return (
        <DashboardLayout user={data.user}>
            <AdminLibraryView user={data.user} />
        </DashboardLayout>
    );
}

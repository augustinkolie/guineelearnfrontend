        ...
        <div className="space-y-10 pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200  shadow-gray-100/50 p-8 text-center relative overflow-hidden group">
                        ...
                        <div className="relative pt-6 space-y-4">
                            <div className="relative inline-block">
                                <div className="w-36 h-36 rounded-lg bg-white border-8 border-white  flex items-center justify-center overflow-hidden mx-auto transition-transform group-hover:scale-105 duration-500">
                                    {user?.avatar ? (
                                ...
                                <button className="absolute -bottom-2 -right-2 p-3 bg-[#1B6B3A] text-white rounded-lg  border-4 border-white hover:scale-110 active:scale-95 ">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200  shadow-gray-100/50 p-3 space-y-1">
                        {tabs.map((tab) => (
                            <button
                                key={tab.id}
                                onClick={() => setActiveTab(tab.id)}
                                className={`w-full flex items-center justify-between p-4 rounded-lg  group ${
                                    activeTab === tab.id 
                ...
                <div className="lg:col-span-8">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="bg-white rounded-lg border border-gray-200  shadow-gray-100/50 overflow-hidden"
                        >
                            {/* Tab Content Header */}
                                    ...
                                    <div className="space-y-8">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input type="text" defaultValue={user?.fullName} className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans" />
                                                </div>
                                            </div>
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input type="email" defaultValue={user?.email} className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans" />
                                                </div>
                                            </div>
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input type="tel" placeholder="+224 62X XX XX XX" className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans" />
                                                </div>
                                            </div>
                                            <div className="space-y-3">
                                                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest pl-1">Genre</label>
                                                <select className="w-full px-4 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans appearance-none">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <textarea 
                                                ...
                                                className="w-full p-6 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans resize-none"
                                            />
                                        </div>

                                        <div className="flex justify-end pt-4">
                                            <button className="px-10 py-4.5 bg-[#1B6B3A] text-white rounded-lg font-black text-[11px] uppercase tracking-widest  shadow-[#1B6B3A]/20  active:scale-95 ">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input type="text" defaultValue="Lycée 02 Octobre" className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans" />
                                                </div>
                                            </div>
                                            <div className="space-y-3">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input type="text" defaultValue="Conakry" className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans" />
                                                </div>
                                            </div>
                                            <div className="space-y-3">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="grid grid-cols-1 gap-6">
                                                <div className="space-y-3">
                                                    ...
                                                    <input type="password" placeholder="••••••••" className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-lg text-sm font-bold text-[#0F2D1E] focus:outline-none focus:ring-2 focus:ring-[#1B6B3A]/10 focus:border-[#1B6B3A]/40  font-sans" />
                                                </div>
                                            ...
                                            <div className="flex justify-end">
                                                <button className="px-10 py-4.5 bg-[#0F2D1E] text-white rounded-lg font-black text-[11px] uppercase tracking-widest  shadow-[#0F2D1E]/20  active:scale-95 ">
                                                    Actualiser le mot de passe
                                                </button>
                                            </div>
                                        </div>

                                        <div className="p-8 bg-[#E8F5EE] border border-[#1B6B3A]/20 rounded-lg flex items-center justify-between group">
                                ...
                                {activeTab === 'notifications' && (
                                    <div className="space-y-6">
                                        {[
                                            ...
                                            <div key={idx} className="flex items-center justify-between p-6 bg-gray-50/30 rounded-lg group hover:bg-white hover: hover:shadow-gray-100  border border-transparent hover:border-gray-50">
                                                <div className="flex items-center gap-6">
                                                    <div className={`p-4 rounded-lg transition-colors ${item.active ? 'bg-[#E8F5EE] text-[#1B6B3A]' : 'bg-gray-100 text-gray-400'}`}>
                                                ...
                                                <div className={`w-14 h-7 rounded-full relative cursor-pointer  duration-300 ${item.active ? 'bg-[#1B6B3A] shadow-inner shadow-black/10' : 'bg-gray-200'}`}>
                                                    <div className={`absolute top-1 w-5 h-5 bg-white rounded-full   duration-300 ${item.active ? 'right-1' : 'left-1'}`} />
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                    ...
                    {/* Danger Zone */}
                    <div className="mt-10 p-8 rounded-lg border border-rose-100 bg-rose-50/30 flex items-center justify-between group hover:bg-rose-50 transition-colors">
                        <div>
                        ...
                        <button className="px-6 py-3 bg-rose-600/10 text-rose-600 rounded-lg font-bold text-xs hover:bg-rose-600 hover:text-white ">
